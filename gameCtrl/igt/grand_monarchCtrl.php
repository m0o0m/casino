...
class grand_monarchCtrl extends IGTCtrl {
    ...
    <PaytableStatistics description="Grand Monarch 50L 4x4x4x4x4" maxRTP="94.97" minRTP="92.99" name="Grand Monarch" type="Slot"/>
    ...
    <DenominationList>
        <Denomination softwareId="200-1154-001">1.0</Denomination>
    </DenominationList>
    <GameBetInfo>
    ...
    <OutcomeDetail>
        <TransactionId>A2210-14264043334038</TransactionId>
        <Stage>'.$state.'</Stage>
