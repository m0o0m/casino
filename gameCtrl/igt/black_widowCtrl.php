...
class black_widowCtrl extends IGTCtrl {
    ...
    <PrizeInfo multiplierStrategy="null" name="PrizeInfoLines" strategy="payLeft">
        <Prize name="s01">
            <PrizePay count="5" value="50" />
            <PrizePay count="4" value="20" />
            <PrizePay count="3" value="10" />
            <PrizePay count="2" value="4" />
            <Symbol id="w01" required="false" />
            <Symbol id="s01" required="true" />
        </Prize>
        <Prize name="s02">
            <PrizePay count="5" value="25" />
            <PrizePay count="4" value="15" />
            <PrizePay count="3" value="7" />
            <Symbol id="w01" required="false" />
        ...
        <Prize name="s05">
            <PrizePay count="5" value="15" />
            <PrizePay count="4" value="10" />
            <PrizePay count="3" value="5" />
            <Symbol id="w01" required="false" />
            <Symbol id="s05" required="true" />
        </Prize>
        <Prize name="s06">
            <PrizePay count="5" value="14" />
            <PrizePay count="4" value="9" />
            <PrizePay count="3" value="4" />
            <Symbol id="w01" required="false" />
            <Symbol id="s06" required="true" />
        </Prize>
        <Prize name="s07">
            <PrizePay count="5" value="13" />
            <PrizePay count="4" value="8" />
            <PrizePay count="3" value="3" />
            <Symbol id="w01" required="false" />
            <Symbol id="s07" required="true" />
        </Prize>
        <Prize name="s08">
            <PrizePay count="5" value="12" />
            <PrizePay count="4" value="7" />
            <PrizePay count="3" value="2" />
            <Symbol id="w01" required="false" />
            <Symbol id="s08" required="true" />
        </Prize>
        <Prize name="s09">
            <PrizePay count="5" value="11" />
            <PrizePay count="4" value="6" />
            <PrizePay count="3" value="1" />
            <Symbol id="w01" required="false" />
            <Symbol id="s09" required="true" />
        </Prize>
        <Prize name="w01">
            <PrizePay count="5" value="1000" />
            <PrizePay count="4" value="250" />
            <PrizePay count="3" value="50" />
            <PrizePay count="2" value="10" />
    ...
    <Balances totalBalance="3000.00">
        <Balance name="FREE">3000.00</Balance>
    </Balances>
</GameLogicResponse>';
