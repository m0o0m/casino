...
class crown_of_egyptCtrl extends IGTCtrl {
    ...
    <param name="game" value="CrownOfEgypt" />
    ...
    <PaytableStatistics description="Crown Of Egypt 40L + 1024 Ways" maxRTP="95.03" minRTP="92.90" name="Crown Of Egypt" type="Slot"/>
    ...
    <DenominationList>
        <Denomination softwareId="200-1176-001">1.0</Denomination>
    </DenominationList>
    <GameBetInfo>
