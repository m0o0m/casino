...
class one_hundred_pandasCtrl extends IGTCtrl {
    ...
    <DenominationList>
        <Denomination softwareId="200-1182-001">1.0</Denomination>
    </DenominationList>
    <GameBetInfo>
    ...
    <OutcomeDetail>
        <TransactionId>A2110-14264049050795</TransactionId>
        <Stage>'.$state.'</Stage>
    ...
    <PopulationOutcome name="BaseGame.Reels" stage="BaseGame">
        <Entry name="Reel0" stripIndex="1">
            <Cell name="L0C0R0" stripIndex="0">s10</Cell>
            <Cell name="L0C0R1" stripIndex="1">s01</Cell>
            <Cell name="L0C0R2" stripIndex="2">s01</Cell>
            <Cell name="L0C0R3" stripIndex="3">s08</Cell>
        </Entry>
        <Entry name="Reel1" stripIndex="1">
            <Cell name="L0C1R0" stripIndex="0">s05</Cell>
            <Cell name="L0C1R1" stripIndex="1">s09</Cell>
            <Cell name="L0C1R2" stripIndex="2">s07</Cell>
            <Cell name="L0C1R3" stripIndex="3">s01</Cell>
        </Entry>
    ...
    <PopulationOutcome name="FreeSpin.Reels" stage="FreeSpin">
        <Entry name="Reel0" stripIndex="1">
            <Cell name="L0C0R0" stripIndex="0">s02</Cell>
        ...
        <Entry name="Reel2" stripIndex="1">
            ...
            <Cell name="L0C2R3" stripIndex="3">w01</Cell>
        </Entry>
        <Entry name="Reel3" stripIndex="1">
            <Cell name="L0C3R0" stripIndex="0">s09</Cell>
            <Cell name="L0C3R1" stripIndex="1">s07</Cell>
            <Cell name="L0C3R2" stripIndex="2">s03</Cell>
            <Cell name="L0C3R3" stripIndex="3">s03</Cell>
        </Entry>
        <Entry name="Reel4" stripIndex="1">
            <Cell name="L0C4R0" stripIndex="0">s08</Cell>
            <Cell name="L0C4R1" stripIndex="1">s01</Cell>
            <Cell name="L0C4R2" stripIndex="2">s01</Cell>
            <Cell name="L0C4R3" stripIndex="3">s09</Cell>
        </Entry>
    </PopulationOutcome>
    <PatternSliderInput>
