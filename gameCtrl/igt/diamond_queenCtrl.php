...
class diamond_queenCtrl extends IGTCtrl {
    ...
    <DenominationList>
        <Denomination softwareId="200-1163-001">1.0</Denomination>
    </DenominationList>
    <GameBetInfo>
    ...
    <OutcomeDetail>
        <TransactionId>A2310-14264037699060</TransactionId>
        <Stage>'.$state.'</Stage>
    ...
    <PopulationOutcome name="BaseGame.Reels" stage="BaseGame">
        <Entry name="Reel0" stripIndex="26">
            <Cell name="L0C0R0" stripIndex="9">s03</Cell>
            <Cell name="L0C0R1" stripIndex="10">s08</Cell>
            <Cell name="L0C0R2" stripIndex="11">s05</Cell>
        </Entry>
        <Entry name="Reel1" stripIndex="37">
            <Cell name="L0C1R0" stripIndex="38">s02</Cell>
            <Cell name="L0C1R1" stripIndex="39">s06</Cell>
            <Cell name="L0C1R2" stripIndex="40">s01</Cell>
        </Entry>
        <Entry name="Reel2" stripIndex="24">
            <Cell name="L0C2R0" stripIndex="45">s02</Cell>
            <Cell name="L0C2R1" stripIndex="46">s08</Cell>
            <Cell name="L0C2R2" stripIndex="47">s03</Cell>
        </Entry>
        <Entry name="Reel3" stripIndex="42">
            <Cell name="L0C3R0" stripIndex="76">b01</Cell>
            <Cell name="L0C3R1" stripIndex="77">s02</Cell>
            <Cell name="L0C3R2" stripIndex="78">s08</Cell>
        </Entry>
        <Entry name="Reel4" stripIndex="53">
            <Cell name="L0C4R0" stripIndex="57">s08</Cell>
            <Cell name="L0C4R1" stripIndex="58">s06</Cell>
            <Cell name="L0C4R2" stripIndex="59">s03</Cell>
        </Entry>
    </PopulationOutcome>
    '.$display2.'
    <PatternSliderInput>
