...
class pamplonaCtrl extends IGTCtrl {
    ...
    <PaytableStatistics description="Pamplona 1024 Multiway 4x4x4x4x4" maxRTP="96.03" minRTP="92.89" name="Pamplona" type="Slot"/>
    ...
    <DenominationList>
        <Denomination softwareId="200-1185-001">1.0</Denomination>
    </DenominationList>
    <GameBetInfo>
    ...
    <OutcomeDetail>
        <TransactionId>A2310-14264037738741</TransactionId>
        <Stage>'.$state.'</Stage>
    ...
    <PopulationOutcome name="BaseGame.Reels" stage="BaseGame">
        <Entry name="Reel0" stripIndex="123">
            <Cell name="L0C0R0" stripIndex="123">s03</Cell>
            <Cell name="L0C0R1" stripIndex="124">s11</Cell>
            <Cell name="L0C0R2" stripIndex="125">b01</Cell>
            <Cell name="L0C0R3" stripIndex="126">s10</Cell>
        </Entry>
        <Entry name="Reel1" stripIndex="112">
            <Cell name="L0C1R0" stripIndex="112">s08</Cell>
            <Cell name="L0C1R1" stripIndex="113">s01</Cell>
            <Cell name="L0C1R2" stripIndex="114">s01</Cell>
            <Cell name="L0C1R3" stripIndex="115">s01</Cell>
        </Entry>
        <Entry name="Reel2" stripIndex="0">
            <Cell name="L0C2R0" stripIndex="0">w01</Cell>
            <Cell name="L0C2R1" stripIndex="1">s08</Cell>
            <Cell name="L0C2R2" stripIndex="2">s05</Cell>
            <Cell name="L0C2R3" stripIndex="3">s06</Cell>
        </Entry>
        <Entry name="Reel3" stripIndex="0">
            <Cell name="L0C3R0" stripIndex="0">w01</Cell>
            <Cell name="L0C3R1" stripIndex="1">s10</Cell>
            <Cell name="L0C3R2" stripIndex="2">s11</Cell>
            <Cell name="L0C3R3" stripIndex="3">s09</Cell>
        </Entry>
        <Entry name="Reel4" stripIndex="5">
            <Cell name="L0C4R0" stripIndex="5">s04</Cell>
            <Cell name="L0C4R1" stripIndex="6">s08</Cell>
            <Cell name="L0C4R2" stripIndex="7">s02</Cell>
            <Cell name="L0C4R3" stripIndex="8">s07</Cell>
        </Entry>
    </PopulationOutcome>
    <PopulationOutcome name="Picker.Picks" stage="Picker">
        <Entry name="L0C0R0" stripIndex="0">
