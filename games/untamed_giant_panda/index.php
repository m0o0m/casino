<?
    session_start();
    $_SESSION['server_link'] = 'http://localhost/core/WebEngine.php?game=untamed_giant_panda|||quickfire';
    $_SESSION['lang'] = 'en';
    $_SESSION['static_link'] = 'http://localhost/core/games/untamed_giant_panda/';
    $_SESSION['server_game_link'] = $_SESSION['static_link'];
?>
<html>
<head>
    <title>untamed_giant_panda</title>
</head>
<body>
