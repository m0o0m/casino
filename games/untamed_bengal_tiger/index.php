<?
    session_start();
    $_SESSION['server_link'] = 'http://localhost/core/WebEngine.php?game=untamed_bengal_tiger|||quickfire';
    $_SESSION['lang'] = 'en';
    $_SESSION['static_link'] = 'http://localhost/core/games/untamed_bengal_tiger/';
    $_SESSION['server_game_link'] = $_SESSION['static_link'];
?>
<html>
<head>
    <title>untamed_bengal_tiger</title>
</head>
<body>
