<?
    session_start();
    $_SESSION['server_link'] = 'http://localhost/core/WebEngine.php?game=jurassic_park|||quickfire';
    $_SESSION['lang'] = 'en';
    $_SESSION['static_link'] = 'http://localhost/core/games/jurassic_park/';
    $_SESSION['server_game_link'] = $_SESSION['static_link'];
?>
<html>
<head>
    <title>jurassic_park</title>
</head>
<body>
