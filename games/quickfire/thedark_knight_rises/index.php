<?
    session_start();
    $_SESSION['server_link'] = 'http://localhost/core/WebEngine.php?game=thedark_knight_rises|||quickfire';
    $_SESSION['lang'] = 'en';
    $_SESSION['static_link'] = 'http://localhost/core/games/thedark_knight_rises/';
    $_SESSION['server_game_link'] = $_SESSION['static_link'];
?>
<html>
<head>
    <title>TheDarkKnightRises</title>
</head>
<body>
