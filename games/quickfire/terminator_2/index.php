<?
    session_start();
    $_SESSION['server_link'] = 'http://localhost/core/WebEngine.php?game=terminator_2|||quickfire';
    $_SESSION['lang'] = 'en';
    $_SESSION['static_link'] = 'http://localhost/core/games/terminator_2/';
    $_SESSION['server_game_link'] = $_SESSION['static_link'];
?>
<html>
<head>
    <title>terminator_2</title>
</head>
<body>
