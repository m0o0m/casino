<?
    session_start();
    $_SESSION['server_link'] = 'http://localhost/core/WebEngine.php?game=girls_with_guns|||quickfire';
    $_SESSION['lang'] = 'en';
    $_SESSION['static_link'] = 'http://localhost/core/games/girls_with_guns/';
    $_SESSION['server_game_link'] = $_SESSION['static_link'];
?>
<html>
<head>
    <title>girls_with_guns</title>
</head>
<body>
