<?
    session_start();
    $_SESSION['server_link'] = 'http://localhost/core/WebEngine.php?game=untamed_wolf_pack|||quickfire';
    $_SESSION['lang'] = 'en';
    $_SESSION['static_link'] = 'http://localhost/core/games/untamed_wolf_pack/';
    $_SESSION['server_game_link'] = $_SESSION['static_link'];
?>
<html>
<head>
    <title>untamed_wolf_pack</title>
</head>
<body>
