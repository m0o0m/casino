...
class grace_of_cleopatraParams extends Params {
    ...
    public $reels = array(
        array(
            [8, 1, 4, 0, 5, 2, 6, 1, 5, 7, 3, 2, 1, 4, 2, 9, 5, 6, 8, 2],
            [2, 8, 0, 6, 1, 5, 8, 2, 4, 3, 5, 9, 2, 4, 1, 7, 2, 8, 3, 6],
            [4, 0, 5, 1, 8, 3, 6, 4, 8, 1, 3, 9, 2, 5, 1, 7, 0, 3, 6, 2],
            [2, 6, 1, 5, 3, 8, 1, 7, 0, 5, 2, 6, 7, 1, 4, 8, 6, 3, 4, 9],
            [6, 1, 7, 3, 5, 0, 1, 4, 8, 1, 5, 9, 2, 4, 8, 7, 5, 0, 3, 4]
        ),
        array(
            [8, 1, 4, 0, 5, 2, 6, 1, 5, 7, 3, 2, 1, 4, 2, 9, 5, 6, 8, 2],
            [2, 8, 0, 6, 1, 5, 8, 2, 4, 3, 5, 9, 2, 4, 1, 7, 2, 8, 3, 6],
