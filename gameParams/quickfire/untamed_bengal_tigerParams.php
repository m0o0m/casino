...
class untamed_bengal_tigerParams extends Params {
    public $reels = array(
        ...
        // 16 - 1
        array(
            array(0,7,4,8,9,2,5,6,9,2,3,7,4,9,8,10,9,7,2,8,4,7,8,6,3,7,9,4,8,9,10,7,2,4,8,5,7,8,3,7,9,4,8,9,7,8,9,4,8,9,3,4,7,9,4,8,9,7,8,9,4,8,9,10,1,7,9,1,4,8,1,9,7,1,3,4,8,3,7,4,8,3,7,9,4,8,9,3,8,6,3,9,8,4,9,8),
            array(0,6,8,1,4,6,1,3,8,1,4,2,1,10,2,5,6,8,9,4,6,9,4,2,8,4,2,7,1,6,8,1,4,6,1,5,8,2,1,4,2,8,5,1,6,8,1,4,6,9,5,8,2,5,4,2,5,6,8,4,6,5,7,6,8,5,4,6,7,5,8,2,3,4,2,5,6,8,4,6,5,2,8,4,2,5,6,8,4,6,5,2,1,8,2,1),
            array(0,1,3,6,1,7,5,1,9,3,7,6,9,2,7,5,2,9,3,6,7,5,9,3,6,7,5,10,9,3,6,9,7,5,8,4,9,8,6,7,5,10,9,7,3,9,6,1,7,5,1,9,3,1,6,7,5,10,7,9,3,5,6,9,1,7,5,1,10,3,6,9,7,5,9,7,3,6,1,10,5,8,9,3,4,6,3,7,5,9,3,6,5,3,6,5,3),
            array(0,5,7,8,4,9,6,3,9,5,2,7,8,9,2,6,9,5,7,8,4,9,6,3,9,10,5,7,8,4,9,6,3,9,5,2,7,8,9,2,6,9,5,7,8,4,9,6,3,9,10,7,1,8,4,1,9,6,1,3,9,1,5,2,7,8,2,6,5,7,8,4,9,6,3,9,10,5,7,8,4,6,3,5,2,7,8,2,6,3,5,2,8,7,2,8),
            array(0,3,4,5,8,3,4,2,7,6,2,1,3,4,1,5,8,1,7,6,1,3,4,5,8,3,4,2,7,6,2,3,4,5,8,7,6,10,3,4,5,8,9,7,6,9,3,4,5,8,9,7,6,9,3,4,5,8,2,7,6,2,3,4,5,8,7,6,10,3,4,5,8,9,7,6,9,3,4,5,8,9,7,6,9,3,4,5,8,9,7,5,8,4,5,8),
        ),
    );
    // Символы
    ...
    public $winPay = array(
        ...
        array('symbol'=>'I', 'count'=>5, 'multiplier'=>'200.00'),
        array('symbol'=>'I', 'count'=>4, 'multiplier'=>'100.00'),
        array('symbol'=>'I', 'count'=>3, 'multiplier'=>'25.00'),
        array('symbol'=>'I', 'count'=>2, 'multiplier'=>'2.00'),
        ...
        array('symbol'=>'D', 'count'=>4, 'multiplier'=>'60.00'),
        array('symbol'=>'D', 'count'=>3, 'multiplier'=>'12.00'),
        ...
        array('symbol'=>'K', 'count'=>5, 'multiplier'=>'75.00'),
